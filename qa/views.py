...
def dashboard(request):
    ...
    dic["sectionname2"] = "Conceptual"
    dic["sec1question1"]= qa["Technical"][0][0]
    dic["sec1question2"]= qa["Technical"][1][0]
    dic["sec2question1"]= qa["Conceptual"][0][0]
    dic["sec2question2"]= qa["Conceptual"][1][0]
